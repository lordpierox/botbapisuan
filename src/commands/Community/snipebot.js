...
module.exports = {
    ...
    .setName('snipebot')
    .setDescription('Recupera los ultimos 5 mensajes eliminados (bots)')
    ...
    async execute(interaction, client)  {
        ...
        let comsnipe = global.snipe_bot.clone();
        ...
        for(i = ( comsnipe.length - 1 ); i >= 0; i--){
            ...
            if(comsnipe.get(i).chan == interaction.channel.id){
                ...
                embedArray.add(comsnipe.get(i).embed)
            }
        ...
        .setTimestamp(messDate.get(0));
             ...
             embed1 = embedArray.get(0);
            
        }
       
    
        let embed2;
        if(embedArray.get(1) === undefined ){
        ...
        .setTimestamp(messDate.get(1));
             ...
             embed2 = embedArray.get(1);
            
        }

        let embed3;
        if(embedArray.get(2) === undefined ){
        ...
        .setTimestamp(messDate.get(2));
             ...
             embed3 = embedArray.get(2);
            
        }

        let embed4;
        if(embedArray.get(3) === undefined ){
        ...
        .setTimestamp(messDate.get(3));
             ...
             embed4 = embedArray.get(3);
            
        }

        let embed5;
        if(embedArray.get(4) === undefined ){
