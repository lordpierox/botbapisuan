...
module.exports = {
    ...
    async execute(interaction, client)  {
        ...
        var linkId = "";
        let tags="kaji_ryouji katsuragi_misato -rating:explicit -yaoi -futanari -multiple_boys -2girls -ayanami_rei_(cosplay)";
        let date1;
        let linkImg = "";

        if(interaction.channel.nsfw){ 
            tags = "kaji_ryouji katsuragi_misato rating:explicit -yaoi -futanari -2boys";
