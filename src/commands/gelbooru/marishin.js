...
module.exports = {
    ...
    async execute(interaction, client)  {
        ...
        var linkId = "";
        let tags="makinami_mari_illustrious ikari_shinji -rating:questionable -rating:explicit -threesome -yaoi -multiple_girls -multiple_boys -cup -squirrel -trap -eyepatch -balloon -simple_background 1girl";
        let date1;
        let linkImg = "";

        if(interaction.channel.nsfw){ 
            tags = "makinami_mari_illustrious ikari_shinji rating:explicit -threesome -yaoi -asuka_langley_souryuu  ";
