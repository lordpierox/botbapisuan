...
module.exports = {
    ...
    async execute(interaction, client)  {
        var linkId = "";
        let tags="ayanami_rei  rating:explicit 1girl -1boy -2boys -multiple_boys -interracial -defeat -mass_production_eva -multitasking -injury -futanari -bdsm -bestiality";
        let date1;
        let linkImg = "";
