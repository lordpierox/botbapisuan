...
module.exports = {
    ...
    .setName('nsfwasuka')
    .setDescription('Imagen nsfw de asuka (Explicit)'),
    async execute(interaction, client)  {
        var linkId = "";
        let tags="asuka_langley_souryuu rating:explicit 1girl -1boy -2boys -multiple_boys -interracial -defeat -mass_production_eva sort:random -futanari -bdsm";
        let date1;
        let linkImg = "";
