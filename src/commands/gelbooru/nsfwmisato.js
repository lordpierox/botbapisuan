...
module.exports = {
    ...
    async execute(interaction, client)  {
        var linkId = "";
        let tags="katsuragi_misato  rating:explicit 1girl -1boy -2boys -multiple_boys -interracial -defeat -mass_production_eva -multitasking -injury -futanari -bestiality -you_gonna_get_raped -bdsm";
        let date1;
        let linkImg = "";
