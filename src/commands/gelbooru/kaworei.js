...
module.exports = {
    ...
    async execute(interaction, client)  {
        ...
        var linkId = "";
        let tags="nagisa_kaworu ayanami_rei -rating:explicit  -futanari -2boys -yaoi -multiple_girls -multiple_boys -meme -squirrel -solo";
        let date1;
        let linkImg = "";
       

        if(interaction.channel.nsfw){ 
            tags = "nagisa_kaworu ayanami_rei rating:explicit  -futanari -2boys";
