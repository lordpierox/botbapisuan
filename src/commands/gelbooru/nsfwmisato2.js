...
module.exports = {
    ...
    .setName('nsfwmisato2')
    .setDescription('Imagen nsfw de misato (Questionable)'),
    async execute(interaction, client)  {
        var linkId = "";
        let tags="katsuragi_misato rating:questionable 1girl -1boy -2boys -multiple_boys -interracial -defeat -mass_production_eva sort:random -bdsm";
        let date1;
        let linkImg = "";
